        ...
        <Transition.Root show={props.open} as={Fragment}>
            <Dialog as="div" className="fixed z-20 inset-0 overflow-y-auto" onClose={props.setOpen}>
                <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0" ref={props.wrapperRef}>
                    ...
                    >
                        <div className="text-white font-mono selection:text-gray-800 selection:bg-primary relative inline-block align-bottom bg-slate-800 rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:align-middle sm:max-w-3xl px-10 py-6">
